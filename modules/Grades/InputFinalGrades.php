...
if(AllowEdit())
	...
	if($_REQUEST['use_percents']!='true')
		...
		if(substr($_REQUEST['mp'],0,1)!='E')
		{
			...
			$gb_header .= " | <A HREF=Modules.php?modname=$_REQUEST[modname]&include_inactive=$_REQUEST[include_inactive]&modfunc=gradebook&mp=$_REQUEST[mp]&use_percents=true>Get Gradebook Grades</A>";
