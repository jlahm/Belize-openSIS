...
echo "<div class=login_failure><a href=Modules.php?modname=$_REQUEST[modname]&page_display=FAILURE><strong>Set login failure allowance count</strong>
</a></div>";
...
echo "<div class=maintenance><a href=Modules.php?modname=$_REQUEST[modname]&page_display=MAINTENANCE><strong>Put system in maintenance mode</strong>
</a></div>";
echo '</div>';
}
