...
{	global $_openSIS;
	...
	if($options['C']){
	if($cal_img!='N'){
		$return .= '<span style="padding-top:4px"<img src="assets/calendar.gif" id="trigger'.$_openSIS['PrepareDate'].'" style="cursor: pointer;" onmouseover=this.style.background=""; onmouseout=this.style.background=""; onClick='."MakeDate('".$_openSIS['PrepareDate']."',this);".' /></div>';
	}
	}
